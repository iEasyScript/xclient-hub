...
This plugin serves as a comprehensive template and reference for developing ProjectX plugins. It demonstrates the complete plugin architecture including configuration, scripting, overlay rendering, and proper RuneLite integration.
...
@PluginDescriptor(
    ...
    description = "ProjectXs Example Plugin", // A brief description of the plugin (optional, default is '')
    tags = {"example", "projectx"}, // Tags to categorize the plugin (optional, default is '')
...
```
src/main/java/net/runelite/client/plugins/projectx/example/
...
src/main/resources/net/runelite/client/plugins/projectx/example/
└── docs/
