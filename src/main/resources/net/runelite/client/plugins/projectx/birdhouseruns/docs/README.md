...
The **Birdhouse Runs Plugin** is an automation tool for Old School RuneScape, designed to efficiently manage and automate birdhouse runs on Fossil Island. Built for the ProjectX RuneLite client, this plugin streamlines the process of collecting and setting up birdhouses, making Hunter training and passive profit easier and more efficient.
...
1. **Enable the Plugin:**  
   Open the ProjectX sidebar, find the Birdhouse Runs Plugin, and enable it.
