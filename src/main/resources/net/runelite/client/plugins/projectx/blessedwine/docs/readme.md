...
2. Start the plugin from the ProjectX plugin panel
...
- **Dependencies**: Core ProjectX functionality only
- **Compatibility**: RuneLite with ProjectX integration

## Support

For issues, questions, or feature requests, please refer to the main ProjectX repository or contact the plugin author.
