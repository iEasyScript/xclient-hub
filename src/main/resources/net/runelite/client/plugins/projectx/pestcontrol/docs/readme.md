# Pest Control Script – ProjectX RuneLite Client

![img.png](assets/img.png)

The **Pest Control Script** automates the Old School RuneScape Pest Control mini-game using the ProjectX RuneLite client.  
...
| **Inventory Setup**       | Loads gear and inventory from a predefined ProjectX setup.                  |
...
- Properly configured **inventory setup** in ProjectX
...
## Disclaimer
This script is intended for use within the **ProjectX RuneLite Client** only.  
