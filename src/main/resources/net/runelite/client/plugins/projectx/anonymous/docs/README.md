# Anonymous Mode – ProjectX RuneLite Client
...
Each masking feature can be toggled individually under: ProjectX Plugins -> Anonymous.
- Character Name
...
## Disclaimer
This plugin is intended for privacy while demonstrating or debugging within the **ProjectX RuneLite Client**. It does not provide gameplay advantages and does not alter server data.
