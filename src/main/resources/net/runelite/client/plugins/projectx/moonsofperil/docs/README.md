...
- The plugin is on the main ProjectX release.
...
- Enable Debug Logs in the plugin configuration, record a clip or video, and post it in the discord Bug Reports channel, following the ProjectX template for Bug Reporting. 