...
The **Virewatch Killer Plugin** automates combat and looting for Virewatch Sentinels in Old School RuneScape. It is designed for use with the ProjectX RuneLite client and provides a hands-free way to efficiently kill Virewatch Sentinels, manage prayer, and loot valuable drops.
...
Open an issue or contribute improvements via the ProjectX Hub repository.
