The Mess – ProjectX RuneLite Client
===================================

![preview](assets/img.gif)

**The Mess** plugin for the ProjectX RuneLite client automates the Hosidius Mess Hall cooking activity, providing an efficient way to train your Cooking skill. It is especially useful for ironman accounts as it requires no starting items to gain competitive experience rates. The plugin handles the entire process, from gathering ingredients to serving the final dish.
...
*   ProjectX RuneLite client

*   Plugin enabled in the ProjectX plugin list
...
Each option can be configured under: **ProjectX Plugins -> The Mess**.
...
This plugin is intended for automating a skilling activity within the **ProjectX RuneLite Client**. It provides gameplay advantages and you use it at your own risk.
