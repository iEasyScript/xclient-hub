...
The **AIO Camdozaal Plugin** is an automation tool for Old School RuneScape, designed to efficiently train skills and perform activities within the Camdozaal area (Giants' Foundry). Built for the ProjectX RuneLite client, this plugin streamlines various Camdozaal minigame tasks, including smithing, resource management, and activity loops, allowing for hands-free and optimized experience gains.
...
1. **Enable the Plugin:**  
   Open the ProjectX sidebar, find the AIO Camdozaal Plugin, and enable it.
