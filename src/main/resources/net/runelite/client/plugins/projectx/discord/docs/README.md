...
The **Discord Plugin** for the ProjectX RuneLite client integrates Discord functionality directly into Old School RuneScape (OSRS). It allows users to receive notifications, interact with Discord, and manage settings from within the RuneLite client.
