...
The **AIO Magic Plugin** is an all-in-one automation tool for Old School RuneScape, designed to train Magic efficiently by supporting a wide range of spells and activities. Built for the ProjectX RuneLite client, this plugin automates various Magic-related tasks, allowing for hands-free and optimized Magic training and resource processing.
...
1. **Enable the Plugin:**  
   Open the ProjectX sidebar, find the AIO Magic Plugin, and enable it.
