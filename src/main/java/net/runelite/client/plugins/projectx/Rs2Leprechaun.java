...
public final class Rs2Leprechaun {
    ...
    public static boolean openExchange() {
        ...
        if (leprechaun == null) {
            ProjectX.log("Tool Leprechaun not found nearby.");
            return false;
        }
    ...
    public static boolean withdrawCompost(int compostItemId) {
        ...
        if (childId == null) {
            ProjectX.log("Unsupported compost item ID for leprechaun withdrawal: " + compostItemId);
            return false;
        }
        ...
        if (compostWidget == null) {
            ProjectX.log("Compost widget not found in leprechaun interface.");
            closeExchange();
            return false;
        }
