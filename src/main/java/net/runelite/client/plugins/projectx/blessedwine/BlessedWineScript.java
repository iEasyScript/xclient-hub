package net.runelite.client.plugins.projectx.blessedwine;
...
public class BlessedWineScript extends Script {
    ...
    public boolean run() {
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            ...
            if (!super.run()) return;
            int maxPrayerLevel = ProjectX.getClient().getRealSkillLevel(Skill.PRAYER);
            ...
            switch (state) {
                ...
                case BLESS_AT_ALTAR:
                    ...
                    ProjectX.getRs2TileObjectCache().query().interact(52799, "Bless");
                ...
                case USE_LIBATION_BOWL:
                    ...
                    ProjectX.getRs2TileObjectCache().query().interact(53018, "Fill");
                ...
                case RESTORE_PRAYER:
                    ...
                    ProjectX.getRs2TileObjectCache().query().interact(52405, "Bask");
    ...
    private int getCurrentXp() {
        return ProjectX.getClient().getSkillExperience(Skill.PRAYER);
    }
