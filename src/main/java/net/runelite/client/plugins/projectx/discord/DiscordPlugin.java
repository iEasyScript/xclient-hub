package net.runelite.client.plugins.projectx.discord;
...
import net.runelite.client.plugins.projectx.util.discord.Rs2Discord;
import net.runelite.client.plugins.projectx.util.discord.models.DiscordEmbed;
