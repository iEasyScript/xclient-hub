package net.runelite.client.plugins.projectx.autobankstander.config;
...
import net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.FletchingMode;
import net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.ArrowType;
import net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.BowType;
import net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.CrossbowType;
import net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.DartType;
import net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.JavelinType;
import net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.ShieldType;
...
public class ConfigData {
    ...
    private net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.BoltType fletchingBoltType = net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.BoltType.BRONZE;
    ...
    public net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.BoltType getFletchingBoltType() { return fletchingBoltType; }
    public void setFletchingBoltType(net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.BoltType fletchingBoltType) { this.fletchingBoltType = fletchingBoltType; }
