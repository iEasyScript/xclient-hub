package net.runelite.client.plugins.projectx.gecooker;
...
import net.runelite.client.plugins.projectx.gecooker.enums.CookingItem;
import net.runelite.client.plugins.projectx.gecooker.enums.GEWorkLocation;
import net.runelite.client.plugins.projectx.gecooker.enums.LogType;
    ...
    private void bank(CookingItem cookingItem) {
        if (Rs2Bank.openBank()) {
            ...
            if (!Rs2Inventory.hasItem(cookingItem.getRawItemID())) {
                ...
                ProjectX.showMessage("Could not find cooking item in bank.");
                shutdown();
            }
            sleep(180, 540);
            Rs2Bank.closeBank();
    ...
    private void bankForFireSupplies(LogType logType) {
        if (Rs2Bank.openBank()) {
            ...
            if (!Rs2Inventory.hasItem("Tinderbox")) {
                ...
                ProjectX.showMessage("Could not find Tinderbox in bank.");
                shutdown();
            }
            ...
            if (!Rs2Inventory.hasItem(logType.getLogID())) {
                ...
                ProjectX.showMessage("Could not find logs in bank.");
                shutdown();
            }
            sleep(180, 540);
            Rs2Bank.closeBank();
