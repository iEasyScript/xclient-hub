...
import net.runelite.client.plugins.projectx.aiofighter.enums.PlayStyle;
...
import net.runelite.client.plugins.projectx.util.skills.slayer.enums.SlayerMaster;
