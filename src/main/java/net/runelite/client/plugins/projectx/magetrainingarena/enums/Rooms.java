package net.runelite.client.plugins.projectx.magetrainingarena.enums;
...
import static net.runelite.client.plugins.projectx.magetrainingarena.MageTrainingArenaScript.tryEquipBestStaffAndCast;
...
public enum Rooms {
    TELEKINETIC("Telekinetic", 23673, null, null, Points.TELEKINETIC,
            () -> {
                ...
                ProjectX.log("TELEKINETIC req met: " + result, Level.DEBUG);
                return result;
            }),
    ...
    ALCHEMIST("Alchemist", 23675,
            ...
            () -> {
                ...
                ProjectX.log("ALCHEMIST req met: HIGH=" + high + " LOW=" + low, Level.DEBUG);
                return high || low;
            }),
    ...
    ENCHANTMENT("Enchantment", 23674,
            ...
            Points.ENCHANTMENT,
            () -> {
                int level = ProjectX.getClient().getBoostedSkillLevel(Skill.MAGIC);
                boolean result;
                ...
                ProjectX.log("ENCHANTMENT req met (level=" + level + "): " + result, Level.DEBUG);
                return result;
            }),
    ...
    GRAVEYARD("Graveyard", 23676,
            ...
            () -> {
                ...
                ProjectX.log("GRAVEYARD req met: BANANAS=" + bananas + " PEACHES=" + peaches, Level.DEBUG);
                if (!bananas && !peaches) {
                    ProjectX.log("Missing requirement to cast Bones to Bananas or Peaches.", Level.DEBUG);
                    return false;
                }
                return true;
            });
