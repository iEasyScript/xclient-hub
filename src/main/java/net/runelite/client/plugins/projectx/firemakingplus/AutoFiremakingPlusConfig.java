...
@ConfigInformation("<h2>Auto Firemaking Plus</h2>" +
        ...
        "<p>6. <strong>Speed mode:</strong> disables ProjectX antiban. Throwaway accounts only.</p>")
public interface AutoFiremakingPlusConfig extends Config {
    ...
    @ConfigItem(
            ...
            description = "Disables ProjectX's antiban. Faster, more pattern-detectable. Throwaway only.",
            position = 9,
            section = generalSection
    )
