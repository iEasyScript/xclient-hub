...
public class RitualEvent implements BlockingEvent {
    ...
    public boolean validate() {
        try{
            ...
            var dryad = ProjectX.getRs2NpcCache().query()
    ...
    public boolean execute() {
        ...
        while (this.validate()) {
            ...
            if (targetCircle == null) {
                ProjectX.log("RitualEvent: No target circle found, cannot proceed with the ritual.", Level.INFO);
            ...
            if (Rs2Player.getWorldLocation().equals(targetCircle.getWorldLocation())) {
                //ProjectX.log("RitualEvent: Already at the target circle, performing the ritual.", Level.INFO);
                sleepGaussian(600, 150);
                continue; // TODO find some condition to wait for here
            }

            // Move to the target circle
            ProjectX.log("RitualEvent: Moving to the target circle to perform the ritual.", Level.INFO);
        ...
        ProjectX.log("RitualEvent: Finished executing the ritual event.", Level.INFO);
