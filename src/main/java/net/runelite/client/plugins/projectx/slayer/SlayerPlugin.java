...
import net.runelite.client.plugins.projectx.slayer.combat.SlayerDodgeScript;
import net.runelite.client.plugins.projectx.slayer.combat.SlayerFlickerScript;
import net.runelite.client.plugins.projectx.slayer.combat.SlayerHighAlchScript;
...
public class SlayerPlugin extends Plugin {
    ...
    public void onActorDeath(ActorDeath event) {
        try {
            ...
            if (player != ProjectX.getClient().getLocalPlayer()) {
                return;
            }
            ...
            ProjectX.showMessage("You died! Logged out to pause gravestone timer. Recover your items manually.");
