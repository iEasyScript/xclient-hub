...
import net.runelite.client.plugins.projectx.plankrunner.enums.Plank;
import net.runelite.client.plugins.projectx.plankrunner.enums.SawmillLocation;
...
@PluginDescriptor(
        ...
        description = "ProjectX plank runner plugin",
        tags = {"money making", "projectx"},
