...
public class HerbiboarPlugin extends Plugin {
    ...
    protected void startUp() throws AWTException {
        ClientThread clientThread = ProjectX.getClientThread();
        HerbiboarConfig config = provideConfig(ProjectX.getConfigManager());

        setStartTime(Instant.now());
        setStartXp(ProjectX.getClient().getSkillExperience(Skill.HUNTER));
    ...
    public int calculateXpPerHour() {
        ...
        int currentXP = ProjectX.getClient().getSkillExperience(Skill.HUNTER);
