package net.runelite.client.plugins.projectx.aiomagic;
...
import net.runelite.client.plugins.projectx.aiomagic.AIOMagicConfig;
import net.runelite.client.plugins.projectx.aiomagic.AIOMagicOverlay;
import net.runelite.client.plugins.projectx.aiomagic.enums.StunSpell;
import net.runelite.client.plugins.projectx.aiomagic.enums.SuperHeatItem;
import net.runelite.client.plugins.projectx.aiomagic.enums.TeleportSpell;
import net.runelite.client.plugins.projectx.aiomagic.scripts.*;
...
@PluginDescriptor(
        ...
        description = "ProjectX Magic plugin",
