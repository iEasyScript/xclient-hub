...
import net.runelite.client.plugins.projectx.motherloadmine.MotherloadMineScript;
import static net.runelite.client.plugins.projectx.motherloadmine.MotherloadMineScript.status;
