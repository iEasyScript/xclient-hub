package net.runelite.client.plugins.projectx.projectxdashboardplus.data;
 ...
 *
 * <p>Produced by {@link net.runelite.client.plugins.projectx.projectxdashboardplus.poller.GameStatePoller}
...
public class PollSnapshot {
    ...
    public static class AntibanState {
        ...
        /** True when every script is globally paused (ProjectX.pauseAllScripts). */
