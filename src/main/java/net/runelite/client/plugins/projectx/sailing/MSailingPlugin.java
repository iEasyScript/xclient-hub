...
import net.runelite.client.plugins.projectx.sailing.features.salvaging.SalvagingHighlight;
...
import net.runelite.client.plugins.projectx.sailing.features.trials.debug.BoatPathOverlay;
import net.runelite.client.plugins.projectx.sailing.features.trials.overlay.TrialRouteOverlay;
...
@PluginDescriptor(
	...
	description = "ProjectX Sailing Plugin",
	tags = {"sailing"},
	authors = { "Mocrosoft" },
