...
@PluginDescriptor(
        ...
        iconUrl = "https://ieasyscript.github.io/xclient-hub/npcTannerPlugin/assets/icon.png", // URL to plugin icon shown in client (optional)
        cardUrl = "https://ieasyscript.github.io/xclient-hub/npcTannerPlugin/assets/card.png", // URL to plugin card image for website (optional)
