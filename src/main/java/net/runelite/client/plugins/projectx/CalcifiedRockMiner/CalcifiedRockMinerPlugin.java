...
import net.runelite.client.plugins.projectx.CalcifiedRockMiner.CalcifiedRockMinerOverlay;
import net.runelite.client.plugins.projectx.CalcifiedRockMiner.CalcifiedRockMinerScript;
...
@PluginDescriptor(
        ...
        tags = {"prayer", "rock", "calcified", "taf", "projectx"},
...
public class CalcifiedRockMinerPlugin extends Plugin {
    ...
    @Inject
    private net.runelite.client.plugins.projectx.CalcifiedRockMiner.CalcifiedRockMinerConfig config;
    @Inject
    ...
    @Provides
    net.runelite.client.plugins.projectx.CalcifiedRockMiner.CalcifiedRockMinerConfig provideConfig(ConfigManager configManager) {
