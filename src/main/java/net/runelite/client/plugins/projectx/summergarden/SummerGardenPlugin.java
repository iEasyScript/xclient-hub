...
import  net.runelite.client.plugins.projectx.summergarden.SummerGardenOverlay;
import  net.runelite.client.plugins.projectx.summergarden.SummerGardenScript;
...
@PluginDescriptor(
        ...
        description = " ProjectX Summers Garden (V2.1)",
        tags = {"Summers Garden", "minigame", "thieving", "projectx", "skilling", "summer", "summers", "garden", "sq'irk", "juice"},
...
public class SummerGardenPlugin extends Plugin
{
    ...
    @Inject
    public  net.runelite.client.plugins.projectx.summergarden.SummerGardenConfig config;
    ...
    @Provides
     net.runelite.client.plugins.projectx.summergarden.SummerGardenConfig provideConfig(ConfigManager configManager)
    {
