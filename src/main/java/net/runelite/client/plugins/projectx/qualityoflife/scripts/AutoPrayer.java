...
import net.runelite.client.plugins.projectx.qualityoflife.enums.WeaponAnimation;
import net.runelite.client.plugins.projectx.qualityoflife.enums.WeaponID;
...
public class AutoPrayer extends Script {
    ...
    private static int getOffensivePrayerSkillLevel() {
        ...
        return ProjectX.getClient().getRealSkillLevel(Skill.PRAYER);
    }
    ...
    private static boolean isLastManStandingWorld() {
        ...
        return ProjectX.getClient().getWorldType().contains(WorldType.LAST_MAN_STANDING);
    }
