...
@PluginDescriptor(
    ...
    iconUrl = "https://ieasyscript.github.io/xclient-hub/FarmingContractPlugin/assets/icon.png",
    cardUrl = "https://ieasyscript.github.io/xclient-hub/FarmingContractPlugin/assets/card.png",
