...
/**
 * Configuration for the ProjectXDashboardPlus plugin.
 *
 * <p>Sections:
 * <ul>
 ...
 * </ul>
 */
@ConfigGroup("ProjectXDashboardPlus")
@ConfigInformation(
    "<h2>ProjectX Dashboard Plus</h2>" +
    "<h3>Version: " + ProjectXDashboardPlusPlugin.version + "</h3>" +
...
public interface ProjectXDashboardPlusConfig extends Config {
