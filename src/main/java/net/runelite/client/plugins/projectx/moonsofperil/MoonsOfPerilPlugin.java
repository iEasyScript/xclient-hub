...
@PluginDescriptor(
        ...
        tags = {"bossing", "pvm", "moneymaking", "combat", "projectx"},
        authors = "The Funk",
        version = MoonsOfPerilPlugin.version,
        minClientVersion = "2.0.14",
        iconUrl = "https://ieasyscript.github.io/xclient-hub/MoonsOfPerilPlugin/assets/icon.png",
        cardUrl = "https://ieasyscript.github.io/xclient-hub/MoonsOfPerilPlugin/assets/card.png",
