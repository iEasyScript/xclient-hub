package net.runelite.client.plugins.projectx.chatbot;
...
public class ChatbotScript extends Script {
    ...
    private boolean passesFilters(String sender, String message) {
        // Ignore self
        if (config.ignoreSelf() && ProjectX.isLoggedIn()) {
            String localName = ProjectX.getClient().getLocalPlayer().getName();
