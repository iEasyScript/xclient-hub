...
public class DodgeProjectileScript extends Script {
    ...
    public boolean run(AIOFighterConfig config) {
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            ...
            int cycle = ProjectX.getClient().getGameCycle();
            ...
            WorldPoint playerLocation = ProjectX.getClientThread().invoke(() -> ProjectX.getClient().getLocalPlayer().getWorldLocation()); // replaceable with Rs2Player.getWorldLocation() ?
