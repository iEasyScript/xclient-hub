...
public class CharterCrafterOverlay extends OverlayPanel {
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        int currentMagicXp = ProjectX.getClient() != null ? ProjectX.getClient().getSkillExperience(Skill.MAGIC) : 0;
        int currentCraftingXp = ProjectX.getClient() != null ? ProjectX.getClient().getSkillExperience(Skill.CRAFTING) : 0;
