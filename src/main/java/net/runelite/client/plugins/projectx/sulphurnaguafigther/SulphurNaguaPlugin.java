package net.runelite.client.plugins.projectx.sulphurnaguafigther; // Passen Sie den Paketnamen an
...
@PluginDescriptor(
        ...
        tags = {"combat", "pvm", "nagua", "varlamore", "projectx"},
        authors = { "VIP" },
        version = SulphurNaguaPlugin.version,
        minClientVersion = "2.6.12",
        cardUrl = "https://ieasyscript.github.io/xclient-hub/SulphurNaguaPlugin/assets/card.png",
        iconUrl = "https://ieasyscript.github.io/xclient-hub/SulphurNaguaPlugin/assets/icon.png",
...
public class SulphurNaguaPlugin extends Plugin {
    ...
    public long getXpGained() {
        ...
        return ProjectX.getClient().getOverallExperience() - scriptStartExp;
    }
