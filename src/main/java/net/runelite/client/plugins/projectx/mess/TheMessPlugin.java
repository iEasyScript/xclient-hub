...
public class TheMessPlugin extends Plugin {
    ...
    protected void startUp() throws AWTException {
        ...
        ProjectX.log(org.slf4j.event.Level.INFO,"The Mess Plugin is starting up...");

        setStartTime(Instant.now());
        setStartXp(ProjectX.getClient().getSkillExperience(Skill.COOKING));
    ...
    protected void shutDown() {
        ProjectX.log(org.slf4j.event.Level.INFO,"The Mess Plugin is shutting down...");
    ...
    public int calculateXpPerHour() {
        ...
        int currentXP = ProjectX.getClient().getSkillExperience(Skill.COOKING);
    ...
    public void onGameTick(GameTick event) {
        ...
        setCurrentLevel(ProjectX.getClient().getRealSkillLevel(Skill.COOKING));
