...
public class WildernessAgilityPlugin extends Plugin {
    ...
    protected void startUp() throws Exception {
        ProjectX.log("WildernessAgilityPlugin: startUp called");
    ...
    protected void shutDown() throws Exception {
        ProjectX.log("WildernessAgilityPlugin: shutDown called");
        if (script != null) {
            script.shutdown();
        }
        if (overlayManager != null) {
    ...
    public void onChatMessage(ChatMessage chatMessage) {
        ...
        if (chatMessage.getType() == ChatMessageType.GAMEMESSAGE && cleanMsg.equals("Oh dear, you are dead!")) {
            ProjectX.log("[WildernessAgility] Death detected via chat message");
