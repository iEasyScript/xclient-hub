...
public class HivesEvent implements BlockingEvent {
    ...
    public boolean validate() {
        try{
            ...
            var beehives = ProjectX.getRs2NpcCache().query()
    ...
    public boolean execute() {
        ...
        while (this.validate()) {
            ...
            List<Rs2NpcModel> availableBeehives = ProjectX.getRs2NpcCache().query()
            ...
            if (ProjectX.getRs2NpcCache().query().where(x -> x.getIndex() == targetBeehive.getIndex()).count() == 0) {
