    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            panelComponent.getChildren().add(LineComponent.builder()
                    ...
                    .build());
            panelComponent.getChildren().add(LineComponent.builder()
                    .left("ProjectX status: " + ProjectX.status)
                    .leftColor(Color.WHITE)
                    .build());
            var lootRecord = ProjectX.getAggregateLootRecords("Demonic Gorilla");
            ...
            panelComponent.getChildren().add(LineComponent.builder()
                    ...
                    .build());
            panelComponent.getChildren().add(LineComponent.builder()
                    .left("Total loot: " + ProjectX.getAggregateLootRecordsTotalGevalue("Demonic Gorilla"))
                    .leftColor(Color.WHITE)
                    .build());
            panelComponent.getChildren().add(LineComponent.builder()
