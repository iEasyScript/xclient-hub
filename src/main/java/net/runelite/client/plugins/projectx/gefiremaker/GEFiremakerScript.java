package net.runelite.client.plugins.projectx.gefiremaker;
...
import net.runelite.client.plugins.projectx.gefiremaker.enums.GEWorkLocation;
import net.runelite.client.plugins.projectx.gefiremaker.enums.LogType;
    ...
    private void bank(LogType logType) {
        if (Rs2Bank.openBank()) {
            ...
            if (!Rs2Inventory.hasItem(logType.getLogID())) {
                ...
                ProjectX.showMessage("Could not find log type in bank.");
                shutdown();
            }
            sleep(180, 540);
            Rs2Bank.closeBank();
