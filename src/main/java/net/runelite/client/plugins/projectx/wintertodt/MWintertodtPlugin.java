...
@PluginDescriptor(
        ...
        tags = {"Wintertodt", "projectx", "firemaking", "minigame"},
        authors = {"Mocrosoft"},
        version = MWintertodtPlugin.version,
        minClientVersion = "2.0.7",
        cardUrl = "https://ieasyscript.github.io/xclient-hub/MWintertodtPlugin/assets/card.jpg",
        iconUrl = "https://ieasyscript.github.io/xclient-hub/MWintertodtPlugin/assets/icon.jpg",
...
public class MWintertodtPlugin extends Plugin {
    ...
    private boolean isInWintertodtRegion() {
        return ProjectX.getClient().getLocalPlayer().getWorldLocation().getRegionID() == 6462;
    }
