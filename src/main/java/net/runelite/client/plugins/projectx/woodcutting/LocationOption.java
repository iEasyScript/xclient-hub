...
public class LocationOption {
    ...
    public boolean hasRequirements() {
        ...
        boolean varbitRequirementsMet = requiredVarbits.entrySet().stream()
                .allMatch(varbitReq -> ProjectX.getVarbitValue(varbitReq.getKey()) == varbitReq.getValue());
        ...
        boolean varplayerRequirementsMet = requiredVarplayer.entrySet().stream()
                .allMatch(varplayerReq -> ProjectX.getVarbitPlayerValue(varplayerReq.getKey()) == varplayerReq.getValue());
        ...
        boolean itemRequirementsMet = requiredItems.entrySet().stream()
                .allMatch(itemReq -> {
                    ...
                    if (numberOfItems+numberOfItemsInPouch +numberOfItemsInBank< requiredAmount) {
                        ...
                        ProjectX.log("Missing required item: " + itemId + " x" + requiredAmount + " (have " + numberOfItems + ")");
                        return false;
                    }
                    return true;
                });
