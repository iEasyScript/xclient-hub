...
import static net.runelite.client.plugins.projectx.giantsfoundry.enums.CommissionType.*;
import static net.runelite.client.plugins.projectx.giantsfoundry.enums.MouldType.*;
