...
import net.runelite.client.plugins.projectx.autobankstander.config.ConfigData;
...
public class AutoBankStanderPanel extends PluginPanel {
    ...
    private void updateFletchingConfiguration(FletchingMode mode) {
        ...
        switch (mode) {
            ...
            case BOLTS:
                JComboBox<net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.BoltType> fletchingBoltDropdown = 
                    new JComboBox<>(net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.BoltType.values());
                fletchingBoltDropdown.setSelectedItem(currentConfig.getFletchingBoltType());
                fletchingBoltDropdown.addActionListener(e -> {
                    currentConfig.setFletchingBoltType((net.runelite.client.plugins.projectx.autobankstander.skills.fletching.enums.BoltType) fletchingBoltDropdown.getSelectedItem());
                });
