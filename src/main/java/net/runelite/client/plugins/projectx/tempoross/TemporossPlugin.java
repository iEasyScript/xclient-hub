...
@PluginDescriptor(
        ...
        tags = {"Tempoross", "minigame", "s1d", "see1duck", "projectx", "fishing", "skilling"},
...
public class TemporossPlugin extends Plugin {
    ...
    public void onGameTick(GameTick e) {
        ...
        Rs2NpcModel doubleFishingSpot = ProjectX.getRs2NpcCache().query().withId(NpcID.FISHING_SPOT_10569).nearest();
    ...
    public static void setHarpoonType(HarpoonType harpoonType) {
        ProjectX.getConfigManager().setConfiguration("projectx-tempoross", "harpoonType", harpoonType);
    }

    // Set rope config
    public static void setRope(boolean rope) {
        ProjectX.getConfigManager().setConfiguration("projectx-tempoross", "rope", rope);
    }
}
