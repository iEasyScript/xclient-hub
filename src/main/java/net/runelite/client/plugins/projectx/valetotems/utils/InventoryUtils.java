...
public class InventoryUtils {
     ...
     */
    public static int getLogBasketLogCount(net.runelite.client.plugins.projectx.valetotems.models.GameSession gameSession) {
     ...
     */
    public static boolean hasLogBasketSufficientLogs(net.runelite.client.plugins.projectx.valetotems.models.GameSession gameSession) {
     ...
     */
    public static boolean emptyLogBasket(net.runelite.client.plugins.projectx.valetotems.models.GameSession gameSession) {
        try {
            if (gameSession == null) {
     ...
     */
    public static boolean fillLogBasket(net.runelite.client.plugins.projectx.valetotems.models.GameSession gameSession) {
        try {
            if (gameSession == null) {
                System.err.println("GameSession is null - cannot track log basket");
                return false;
     ...
     */
    public static int getOptimalLogAmountForExtendedRoute(net.runelite.client.plugins.projectx.valetotems.models.GameSession gameSession) {
    ...
    public static int getOptimalLogBasketLogAmountForExtendedRoute(net.runelite.client.plugins.projectx.valetotems.models.GameSession gameSession) {
        // Reserve slots: knife, basket, optionally stamina potion
        int reservedSlots = isStaminaSupportEnabled() ? 3 : 2;
     ...
     */
    public static boolean hasEnoughMaterialsForExtendedRoute(net.runelite.client.plugins.projectx.valetotems.models.GameSession gameSession) {
     ...
     */
    public static boolean hasLogBasketSpace(net.runelite.client.plugins.projectx.valetotems.models.GameSession gameSession) {
     ...
     */
    public static int getLogBasketAvailableSpace(net.runelite.client.plugins.projectx.valetotems.models.GameSession gameSession) {
        if (!hasLogBasket() || gameSession == null) {
            return 0;
        }
     ...
     */
    public static boolean shouldEmptyLogBasket(net.runelite.client.plugins.projectx.valetotems.models.GameSession gameSession) {
