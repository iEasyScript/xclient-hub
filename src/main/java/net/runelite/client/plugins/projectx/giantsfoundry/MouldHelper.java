...
import net.runelite.client.plugins.projectx.giantsfoundry.enums.Mould;
...
public class MouldHelper {
    ...
    public static void selectBest()
    {
        ...
        CommissionType type1 = CommissionType.forVarbit(ProjectX.getVarbitValue(SWORD_TYPE_1_VARBIT));
        CommissionType type2 = CommissionType.forVarbit(ProjectX.getVarbitValue(SWORD_TYPE_2_VARBIT));
        ...
        {
            if (bestWidget != null) {
                    ProjectX.doInvoke(new NewMenuEntry(bestWidget.getIndex(), MOULD_LIST_PARENT, MenuAction.CC_OP.getId(), 1, -1, "Select"),
