package net.runelite.client.plugins.projectx.aiofighter.shop;
        ...
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            try {
                ...
                for (ShopItem item : shopItems) {
                    ...
                    int itemPrice = ProjectX.getRs2ItemManager().getPrice(item.getItemId());
                        ...
                        if (Rs2GrandExchange.walkToGrandExchange()) {
                            ...
                            if (Rs2GrandExchange.openExchange()) {
                                ...
                                for (ShopItem item : filteredList) {
                                    ...
                                    int gePrice = ProjectX.getRs2ItemManager().getGEPrice(item.getName());
