...
import  net.runelite.client.plugins.projectx.summergarden.ShowNumbers;
import  net.runelite.client.plugins.projectx.summergarden.SummerGardenConfig;
import  net.runelite.client.plugins.projectx.summergarden.SummerGardenPlugin;
...
public class SummerGardenOverlay extends Overlay
{
    ...
    private final  net.runelite.client.plugins.projectx.summergarden.SummerGardenConfig config;
