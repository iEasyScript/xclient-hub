package net.runelite.client.plugins.projectx.theatre;
...
import net.runelite.client.plugins.projectx.theatre.Bloat.Bloat;
import net.runelite.client.plugins.projectx.theatre.Maiden.Maiden;
import net.runelite.client.plugins.projectx.theatre.Nylocas.Nylocas;
import net.runelite.client.plugins.projectx.theatre.Sotetseg.Sotetseg;
import net.runelite.client.plugins.projectx.theatre.Verzik.Verzik;
import net.runelite.client.plugins.projectx.theatre.Xarpus.Xarpus;
...
@PluginDescriptor(
	...
	tags = {"ToB", "Theatre", "raids", "bloat", "verzik", "nylo", "xarpus", "sotetseg", "maiden", "projectx"},
	authors = {"Syntax"},
