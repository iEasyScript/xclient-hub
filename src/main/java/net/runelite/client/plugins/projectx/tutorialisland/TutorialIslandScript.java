package net.runelite.client.plugins.projectx.tutorialisland;
...
import net.runelite.client.plugins.projectx.util.player.NameGenerator;
...
import static net.runelite.client.plugins.projectx.util.dialogues.Rs2Dialogue.*;
import static net.runelite.client.plugins.projectx.util.settings.Rs2Settings.*;
...
public class TutorialIslandScript extends Script {
    ...
    public void CalculateStatus() {
        ...
        } else if (ProjectX.getVarbitPlayerValue(281) < 10) {
            status = Status.GETTING_STARTED;
        } else if (ProjectX.getVarbitPlayerValue(281) >= 10 && ProjectX.getVarbitPlayerValue(281) < 120) {
            status = Status.SURVIVAL_GUIDE;
        } else if (ProjectX.getVarbitPlayerValue(281) >= 120 && ProjectX.getVarbitPlayerValue(281) < 200) {
            status = Status.COOKING_GUIDE;
        } else if (ProjectX.getVarbitPlayerValue(281) >= 200 && ProjectX.getVarbitPlayerValue(281) <= 250) {
            status = Status.QUEST_GUIDE;
        } else if (ProjectX.getVarbitPlayerValue(281) >= 260 && ProjectX.getVarbitPlayerValue(281) <= 360) {
            status = Status.MINING_GUIDE;
        } else if (ProjectX.getVarbitPlayerValue(281) > 360 && ProjectX.getVarbitPlayerValue(281) < 510) {
            status = Status.COMBAT_GUIDE;
        } else if (ProjectX.getVarbitPlayerValue(281) >= 510 && ProjectX.getVarbitPlayerValue(281) < 540) {
            status = Status.BANKER_GUIDE;
        } else if (ProjectX.getVarbitPlayerValue(281) >= 540 && ProjectX.getVarbitPlayerValue(281) < 610) {
            status = Status.PRAYER_GUIDE;
        } else if (ProjectX.getVarbitPlayerValue(281) >= 610 && ProjectX.getVarbitPlayerValue(281) < 1000) {
            status = Status.MAGE_GUIDE;
        } else if (ProjectX.getVarbitPlayerValue(281) == 1000) {
    ...
    private boolean walkAndAttackRat() {
        ...
        if (playerLoc != null && playerLoc.getX() == 3111 && playerLoc.getY() >= 9516 && playerLoc.getY() <= 9519) {
            if (ProjectX.getRs2TileObjectCache().query().withId(9719).interact("Open")) {
                sleepUntil(() -> {
        ...
        Rs2NpcModel rat = ProjectX.getRs2NpcCache().query().withName("Giant rat").nearest();
    ...
    public void GettingStarted() {
        var npc = ProjectX.getRs2NpcCache().query().withId(NpcID.GIELINOR_GUIDE).nearest();

        if (hasContinue()) return;

        if (ProjectX.getVarbitPlayerValue(281) < 3) {
            if (isInDialogue()) {
            ...
            walkAndTalk(npc);
        } else if (ProjectX.getVarbitPlayerValue(281) < 8) {
    ...
    public void SurvivalGuide() {
        var npc = ProjectX.getRs2NpcCache().query().withId(NpcID.SURVIVAL_EXPERT).nearest();

        if (ProjectX.getVarbitPlayerValue(281) == 10 || ProjectX.getVarbitPlayerValue(281) == 20 || ProjectX.getVarbitPlayerValue(281) == 60) {
            walkAndTalk(npc);
        } else if (ProjectX.getVarbitPlayerValue(281) < 40) {
            Rs2Random.waitEx(1200, 300);
            var widget = Rs2Widget.findWidget("Inventory", true);
            Rs2Widget.clickWidget(widget); // switchToInventoryTab
            Rs2Random.waitEx(1200, 300);
        } else if (ProjectX.getVarbitPlayerValue(281) < 50) {
            fishShrimp();
        } else if (ProjectX.getVarbitPlayerValue(281) < 70) {
            var widget = Rs2Widget.findWidget("Skills", true);
            Rs2Widget.clickWidget(widget); // switchToSkillsTab
            Rs2Random.waitEx(1200, 300);
            walkAndTalk(npc);
        } else if (ProjectX.getVarbitPlayerValue(281) <= 90) {
            ...
            if (!Rs2Inventory.contains("Logs") && (ProjectX.getRs2TileObjectCache().query().withId(ObjectID.FIRE_26185).nearest() == null || Rs2Player.getRealSkillLevel(Skill.WOODCUTTING) == 0)) {
                CutTree();
                return;
            }
            if (ProjectX.getRs2TileObjectCache().query().withId(ObjectID.FIRE_26185).nearest() == null) {
                LightFire();
                return;
            }
    ...
    public void MageGuide() {
        var npc = ProjectX.getRs2NpcCache().query().withId(NpcID.MAGIC_INSTRUCTOR).nearest();

        if (ProjectX.getVarbitPlayerValue(281) == 610 || ProjectX.getVarbitPlayerValue(281) == 620) {
        ...
        } else if (ProjectX.getVarbitPlayerValue(281) == 630) {
            var widget = Rs2Widget.findWidget("Magic", true);
            Rs2Widget.clickWidget(widget); // switchToMagicTab
            Rs2Random.waitEx(1200, 300);
        } else if (ProjectX.getVarbitPlayerValue(281) == 640) {
            walkAndTalk(npc);
        } else if (ProjectX.getVarbitPlayerValue(281) == 650) {
            widgetCast();
        } else if (ProjectX.getVarbitPlayerValue(281) == 680) {
        ...
        } else if (ProjectX.getVarbitPlayerValue(281) >= 660) {
            if (isInDialogue()) {
    ...
    public void PrayerGuide() {
        var npc = ProjectX.getRs2NpcCache().query().withId(NpcID.BROTHER_BRACE).nearest();

        if (ProjectX.getVarbitPlayerValue(281) == 640 || ProjectX.getVarbitPlayerValue(281) == 550 || ProjectX.getVarbitPlayerValue(281) == 540) {
            Rs2Walker.walkTo(new WorldPoint(3124, 3106, 0));
            walkAndTalk(npc);
        } else if (ProjectX.getVarbitPlayerValue(281) == 560) {
            var widget = Rs2Widget.findWidget("Prayer", true);
            Rs2Widget.clickWidget(widget); // switchToPrayerTab
            Rs2Random.waitEx(1200, 300);
        } else if (ProjectX.getVarbitPlayerValue(281) == 570) {
            walkAndTalk(npc);
        } else if (ProjectX.getVarbitPlayerValue(281) == 580) {
            var widget = Rs2Widget.findWidget("Friends list", true);
            Rs2Widget.clickWidget(widget); // switchToFriendsTab
            Rs2Random.waitEx(1200, 300);
        } else if (ProjectX.getVarbitPlayerValue(281) == 600) {
            walkAndTalk(npc);
        }
    }

    public void BankerGuide() {
        var npc = ProjectX.getRs2NpcCache().query().withId(NpcID.ACCOUNT_GUIDE).nearest();

        if (ProjectX.getVarbitPlayerValue(281) == 510) {
            ProjectX.getRs2TileObjectCache().query().interact(ObjectID.BANK_BOOTH_10083);
            sleepUntil(() -> ProjectX.getVarbitPlayerValue(281) != 510);


        } else if (ProjectX.getVarbitPlayerValue(281) == 520) {
            ...
            ProjectX.getRs2TileObjectCache().query().interact(26815); //interactWithPollBooth
            sleepUntil(() -> ProjectX.getVarbitPlayerValue(281) != 520 || Rs2Widget.isWidgetVisible(928, 4));
        } else if (ProjectX.getVarbitPlayerValue(281) == 525 || ProjectX.getVarbitPlayerValue(281) == 530) {
            if (Rs2Widget.isWidgetVisible(928, 4)) {
                Rs2Widget.clickWidget(928, 4); // Close poll booth interface
                Rs2Random.waitEx(1200, 300);
                return;
    ...
    public void CombatGuide() {
        var npc = ProjectX.getRs2NpcCache().query().withId(NpcID.COMBAT_INSTRUCTOR).nearest();

        if (ProjectX.getVarbitPlayerValue(281) <= 370) {
            Rs2Walker.walkTo(new WorldPoint(Rs2Random.between(3106, 3108), Rs2Random.between(9508, 9510), 0));
            Rs2Player.waitForWalking();
            walkAndTalk(npc);
        } else if (ProjectX.getVarbitPlayerValue(281) <= 410) {
            if (isInDialogue()) {
                clickContinue();
                return;
            }
            ...
            walkAndTalk(npc);
        } else if (ProjectX.getVarbitPlayerValue(281) == 500) {
            Rs2Walker.walkTo(new WorldPoint(3111, 9526, Rs2Player.getWorldLocation().getPlane()));
            Rs2Player.waitForWalking();
            ProjectX.getClientThread().invoke(() -> ProjectX.getRs2TileObjectCache().query().withName("Ladder").interact("Climb-up"));
            sleepUntil(() -> ProjectX.getVarbitPlayerValue(281) != 500);
        } else if (ProjectX.getVarbitPlayerValue(281) == 480 || ProjectX.getVarbitPlayerValue(281) == 490) {
            ...
            walkAndAttackRat();
        } else if (ProjectX.getVarbitPlayerValue(281) == 470) {
            if (npc == null) return;
            walkAndTalk(npc);
        } else if (ProjectX.getVarbitPlayerValue(281) == 430) {
            var widget = Rs2Widget.findWidget("Combat Options", true);
            Rs2Widget.clickWidget(widget);
            Rs2Random.waitEx(1200, 300);
        } else if (ProjectX.getVarbitPlayerValue(281) >= 420) {
            if (isInDialogue()) {
                clickContinue();
                return;
            }
            if (ProjectX.getClient().getLocalPlayer().isInteracting() || Rs2Player.isAnimating()) return;
    ...
    public void MiningGuide() {
        var npc = ProjectX.getRs2NpcCache().query().withId(NpcID.MINING_INSTRUCTOR).nearest();

        if (ProjectX.getVarbitPlayerValue(281) == 260) {
            ...
            if (Rs2Inventory.contains("Bronze dagger")) {
                ProjectX.getRs2TileObjectCache().query().interact(ObjectID.GATE_9718, "Open");
                sleepUntil(() -> ProjectX.getVarbitPlayerValue(281) > 360);
                return;
            }
            if (Rs2Inventory.contains("Bronze bar") && Rs2Inventory.contains("Hammer")) {
                ProjectX.getClientThread().invoke(() -> ProjectX.getRs2TileObjectCache().query().withName("Anvil").interact("Smith"));
            ...
            if (Rs2Inventory.contains("Bronze pickaxe") && (!Rs2Inventory.contains("Copper ore") || !Rs2Inventory.contains("Tin ore"))) {
                ...
                ProjectX.getRs2TileObjectCache().query().interact(rockId, "Mine");
                sleepUntil(() -> {
    ...
    public void QuestGuide() {
        var npc = ProjectX.getRs2NpcCache().query().withId(NpcID.QUEST_GUIDE).nearest();

        if (ProjectX.getVarbitPlayerValue(281) == 200 || ProjectX.getVarbitPlayerValue(281) == 210) {
            Rs2Walker.walkTo(new WorldPoint(Rs2Random.between(3083, 3086), Rs2Random.between(3127, 3129), 0));
            ProjectX.getRs2TileObjectCache().query().interact(9716, "Open");
            Rs2Random.waitEx(1200, 300);
        } else if (ProjectX.getVarbitPlayerValue(281) == 220 || ProjectX.getVarbitPlayerValue(281) == 240) {
            walkAndTalk(npc);
        } else if (ProjectX.getVarbitPlayerValue(281) == 230) {
            ...
            Rs2Tab.switchTo(InterfaceTab.INVENTORY);
            Rs2Random.waitEx(600, 100);
            ProjectX.getRs2TileObjectCache().query().interact(9726, "Climb-down");
            Rs2Random.waitEx(2400, 100);
        }
    }

    public void CookingGuide() {
        var npc = ProjectX.getRs2NpcCache().query().withId(NpcID.MASTER_CHEF).nearest();

        if (ProjectX.getVarbitPlayerValue(281) == 120) {
            Rs2Random.waitEx(1200, 300);
            Rs2Keyboard.keyPress(KeyEvent.VK_ESCAPE);
            ProjectX.getRs2TileObjectCache().query().interact(ObjectID.GATE_9470, "Open");
            sleepUntil(() -> ProjectX.getVarbitPlayerValue(281) != 120);
        } else if (ProjectX.getVarbitPlayerValue(281) == 130) {
            ProjectX.getRs2TileObjectCache().query().interact(ObjectID.DOOR_9709, "Open");
            sleepUntil(() -> ProjectX.getVarbitPlayerValue(281) != 130);
        } else if (ProjectX.getVarbitPlayerValue(281) == 140) {
            walkAndTalk(npc);
        } else if (ProjectX.getVarbitPlayerValue(281) >= 150 && ProjectX.getVarbitPlayerValue(281) < 200) {
            if (!Rs2Inventory.contains("Bread dough") && !Rs2Inventory.contains("Bread")) {
                ...
                ProjectX.getRs2TileObjectCache().query().interact(9736, "Use");
                sleepUntil(() -> Rs2Inventory.contains("Bread"));
            } else if (Rs2Inventory.contains("Bread")) {
                if (ProjectX.getRs2TileObjectCache().query().interact(9710, "Open")) {
                    Rs2Random.waitEx(2400, 100);
                }
            }
        }
    ...
    public void CutTree() {
        ProjectX.getClientThread().invoke(() -> ProjectX.getRs2TileObjectCache().query().withName("Tree").interact("Chop down"));
        sleepUntil(() -> Rs2Inventory.hasItem("Logs") && !Rs2Player.isAnimating(2400));
    }

    public void fishShrimp() {
        ProjectX.getRs2NpcCache().query().withId(NpcID.FISHING_SPOT_3317).interact("Net");
    ...
    private boolean widgetCast() {
        ...
        Rs2NpcModel chicken = ProjectX.getRs2NpcCache().query().withName("chicken").nearestOnClientThread();
        ...
        sleepUntil(() -> Rs2Player.isAnimating() || ProjectX.getVarbitPlayerValue(281) != 650, 2_000);
        return true;
    }
