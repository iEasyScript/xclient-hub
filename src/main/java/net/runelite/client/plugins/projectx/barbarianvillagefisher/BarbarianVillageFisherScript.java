package net.runelite.client.plugins.projectx.barbarianvillagefisher;
...
import net.runelite.client.plugins.projectx.barbarianvillagefisher.enums.BarbarianFishingFunctions;
import net.runelite.client.plugins.projectx.barbarianvillagefisher.enums.BarbarianFishingType;
...
public class BarbarianVillageFisherScript extends Script {
        ...
        if (Rs2Bank.openBank()) {
            ...
            if (!Rs2Inventory.hasItem(rodName)) {
                ...
                if (!Rs2Inventory.hasItem(rodName)) {
                    ...
                    ProjectX.showMessage("Could not find fishing rod in bank.");
                    shutdown();
                }
            ...
            if (!Rs2Inventory.hasItem(baitName)) {
                ...
                if (!Rs2Inventory.hasItem(baitName)) {
                    ...
                    ProjectX.showMessage("Could not find bait in bank.");
                    shutdown();
                }
            }
        }
    ...
    private boolean isGameObjectOnTile(WorldPoint location, int id) {
        var result = ProjectX.getRs2TileObjectCache().query()
                .withId(id)
                .within(location, 0)
                .first();
        return result != null;
