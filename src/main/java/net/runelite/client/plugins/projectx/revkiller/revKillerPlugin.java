...
public class revKillerPlugin extends Plugin {
    ...
    @Inject
    private net.runelite.client.plugins.projectx.revkiller.revKillerConfig config;
    @Provides
    net.runelite.client.plugins.projectx.revkiller.revKillerConfig provideConfig(ConfigManager configManager) {
    ...
    @Inject
    private net.runelite.client.plugins.projectx.revkiller.revKillerOverlay revKillerOverlay;

    @Inject
    net.runelite.client.plugins.projectx.revkiller.revKillerScript revKillerScript;
