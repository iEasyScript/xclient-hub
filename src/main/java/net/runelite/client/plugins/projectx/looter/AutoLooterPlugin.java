...
import net.runelite.client.plugins.projectx.looter.scripts.DefaultScript;
import net.runelite.client.plugins.projectx.looter.scripts.FlaxScript;
import net.runelite.client.plugins.projectx.looter.scripts.NatureRuneChestScript;
...
@PluginDescriptor(
        ...
        description = "ProjectX looter plugin",
        tags = {"looter", "projectx"},
