            ...
            try {
                ...
                if (LootedTitanLastIteration) {
                    if (lastLootTime.plusSeconds(15).isBefore(Instant.now())) {
                        ...
                        ProjectX.log("30 seconds passed since last loot - trying again");
                    } else {
                ...
                if (looted && !LootedTitanLastIteration) {
                    ...
                    net.runelite.client.plugins.projectx.RoyalTitans.RoyalTitansShared.evaluateAndConsumePotions(config);
                    ProjectX.log("Looted the titans");
                }
