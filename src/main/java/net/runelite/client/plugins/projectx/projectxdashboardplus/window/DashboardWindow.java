package net.runelite.client.plugins.projectx.projectxdashboardplus.window;

import lombok.extern.slf4j.Slf4j;
import net.runelite.client.plugins.projectx.projectxdashboardplus.ProjectXDashboardPlusConfig;
import net.runelite.client.plugins.projectx.projectxdashboardplus.data.PollSnapshot;
import net.runelite.client.plugins.projectx.projectxdashboardplus.panels.AntibanStatePanel;
import net.runelite.client.plugins.projectx.projectxdashboardplus.panels.DashboardSection;
import net.runelite.client.plugins.projectx.projectxdashboardplus.panels.EventLogPanel;
import net.runelite.client.plugins.projectx.projectxdashboardplus.panels.GuidePanel;
import net.runelite.client.plugins.projectx.projectxdashboardplus.panels.InventoryPanel;
import net.runelite.client.plugins.projectx.projectxdashboardplus.panels.NearbyNpcsPanel;
import net.runelite.client.plugins.projectx.projectxdashboardplus.panels.PlayerPanel;
import net.runelite.client.plugins.projectx.projectxdashboardplus.panels.ScriptsPanel;
import net.runelite.client.plugins.projectx.projectxdashboardplus.panels.SkillsPanel;
import net.runelite.client.plugins.projectx.projectxdashboardplus.panels.XpChartPanel;
import net.runelite.client.plugins.projectx.projectxdashboardplus.poller.GameStatePoller;
...
public class DashboardWindow extends JFrame {
    ...
    private final ProjectXDashboardPlusConfig config;
    ...
    private static final String CONFIG_GROUP = "ProjectXDashboardPlus";
    ...
    public DashboardWindow(GameStatePoller poller, ProjectXDashboardPlusConfig config) {
        super("ProjectX Dashboard Plus");
        this.poller = poller;
        this.config = config;
    ...
    private static Integer readInt(String key) {
        try {
            String raw = ProjectX.getConfigManager().getConfiguration(CONFIG_GROUP, key);
    ...
    private static void writeInt(String key, int value) {
        try {
            ProjectX.getConfigManager().setConfiguration(CONFIG_GROUP, key, Integer.toString(value));
    ...
    private JPanel buildHeader() {
        ...
        JLabel title = new JLabel("ProjectX Dashboard Plus");
    ...
    private JPanel buildFooter() {
        ...
        JLabel info = new JLabel("v" + net.runelite.client.plugins.projectx.projectxdashboardplus.ProjectXDashboardPlusPlugin.version);
