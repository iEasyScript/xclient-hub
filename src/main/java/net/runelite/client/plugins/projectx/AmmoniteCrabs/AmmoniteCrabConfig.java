...
import net.runelite.client.plugins.projectx.AmmoniteCrabs.enums.AmmoniteCrabLocations;
import net.runelite.client.plugins.projectx.AmmoniteCrabs.enums.OffensivePotions;
