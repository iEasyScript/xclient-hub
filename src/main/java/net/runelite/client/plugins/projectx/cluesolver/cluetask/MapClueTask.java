...
public class MapClueTask extends ClueTask {
    ...
    private boolean interactWithObject() {
        ...
        boolean interactionSuccessful = ProjectX.getRs2TileObjectCache().query().interact(objectId, "Search")
                || ProjectX.getRs2TileObjectCache().query().interact(objectId, "Investigate")
                || ProjectX.getRs2TileObjectCache().query().interact(objectId, "Examine")
                || ProjectX.getRs2TileObjectCache().query().interact(objectId, "Look-at")
                || ProjectX.getRs2TileObjectCache().query().interact(objectId, "Open");
