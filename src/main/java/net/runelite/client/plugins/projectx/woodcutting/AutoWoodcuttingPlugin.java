...
import net.runelite.client.plugins.projectx.woodcutting.Forestry.*;
...
@PluginDescriptor(
        ...
        description = "ProjectX woodcutting plugin",
        tags = {"Woodcutting", "projectx", "skilling"},
        authors = {"Mocrosoft"},
...
public class AutoWoodcuttingPlugin extends Plugin {
    ...
    private void addEvents() {
        var eventManager = ProjectX.getBlockingEventManager();
