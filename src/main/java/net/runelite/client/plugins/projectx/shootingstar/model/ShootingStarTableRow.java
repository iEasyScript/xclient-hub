package net.runelite.client.plugins.projectx.shootingstar.model;
...
import net.runelite.client.plugins.projectx.shootingstar.ShootingStarPanel;
	...
	private MouseAdapter createMouseOptions(Star starData, Color backgroundColor)
	{
		return new MouseAdapter()
		{
			...
			public void mouseClicked(MouseEvent e)
			{
				...
				{
					ProjectX.hopToWorld(starData.getWorld());
				}
			}
		};
	}
