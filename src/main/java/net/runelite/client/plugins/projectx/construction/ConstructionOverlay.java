...
import net.runelite.client.plugins.projectx.construction.ConstructionPlugin;
...
public class ConstructionOverlay extends OverlayPanel {
    ...
    private final net.runelite.client.plugins.projectx.construction.ConstructionPlugin plugin;
