            ...
            try {
                ...
                switch (state) {
                    case LOOTING:
                        ...
                        Rs2TileObjectModel flaxObject = ProjectX.getRs2TileObjectCache().query().withName("flax").within(initialPlayerLocation, config.distanceToStray()).nearestOnClientThread();
                        if (flaxObject != null) {
