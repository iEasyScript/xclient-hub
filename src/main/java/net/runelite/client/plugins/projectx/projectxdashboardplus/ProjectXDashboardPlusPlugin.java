package net.runelite.client.plugins.projectx.projectxdashboardplus;
...
import net.runelite.client.plugins.projectx.projectxdashboardplus.window.DashboardWindow;
...
/**
 * ProjectXDashboardPlus is part of the ProjectX Plus suite.
 *
 ...
 * Game state is read in-process via {@link ProjectX#getClient()} and the Rs2
 ...
 */
@PluginDescriptor(
        name = "<html>[<font color=#BB86FC>P</font>] " + "ProjectX Dashboard Plus",
        description = "Native Swing monitoring dashboard for your ProjectX session. Floating window plus a compact sidebar panel. No HTTP, no Agent Server dependency.",
        tags = {"dashboard", "monitoring", "projectx", "plus"},
        authors = {"pjmarz"},
...
@Slf4j
public class ProjectXDashboardPlusPlugin extends Plugin {

    public static final String version = "1.2.1";

    @Inject
    private ProjectXDashboardPlusConfig config;
    ...
    @Provides
    ProjectXDashboardPlusConfig provideConfig(ConfigManager configManager) {
        return configManager.getConfig(ProjectXDashboardPlusConfig.class);
    }
    ...
    protected void startUp() throws AWTException {
        ...
        navButton = NavigationButton.builder()
                .tooltip("ProjectX Dashboard Plus")
        ...
        ProjectX.log("ProjectXDashboardPlus v" + version + " started (native Swing mode)");
    }
    ...
    protected void shutDown() {
        ...
        alertManager = null;
        ProjectX.log("ProjectXDashboardPlus v" + version + " stopped");
    }
    ...
    public void onChatMessage(ChatMessage event) {
        ...
        ProjectX.log("ProjectXDashboardPlus: " + text);
    }

    @Subscribe
    public void onConfigChanged(ConfigChanged event) {
        if (!"ProjectXDashboardPlus".equals(event.getGroup())) return;
