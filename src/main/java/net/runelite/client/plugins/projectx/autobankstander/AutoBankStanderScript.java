...
import net.runelite.client.plugins.projectx.autobankstander.processors.BankStandingProcessor;
...
import net.runelite.client.plugins.projectx.autobankstander.skills.magic.enchanting.EnchantingProcessor;
import net.runelite.client.plugins.projectx.autobankstander.skills.magic.lunars.LunarsProcessor;
import net.runelite.client.plugins.projectx.autobankstander.skills.herblore.HerbloreProcessor;
import net.runelite.client.plugins.projectx.autobankstander.skills.fletching.FletchingProcessor;
...
public class AutoBankStanderScript extends Script {
    ...
    private void handleInitializing() {
        ...
        ProjectX.status = "Initializing..."; // tell the user we are starting up
    ...
    private void handleBanking() {
        ...
        ProjectX.status = "Banking..."; // tell the user we are handling banking
        ...
        if (bankingSuccess) {
            ...
            ProjectX.status = "No required items available";
            shutdown(); // stop the plugin
        }
    }
    ...
    private void handleProcessing() {
        ...
        ProjectX.status = processor.getStatusMessage(); // tell the user what we are doing
    ...
    private void handleErrorRecovery() {
        ...
        ProjectX.status = "Recovering from error..."; // tell the user we are fixing issues
