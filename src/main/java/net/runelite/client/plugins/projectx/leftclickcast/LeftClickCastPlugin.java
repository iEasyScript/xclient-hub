package net.runelite.client.plugins.projectx.leftclickcast;
...
public class LeftClickCastPlugin extends Plugin
{
	...
	{
		// ProjectXConfigPanel renders boolean checkboxes from raw stored values; missing keys read as false
	...
	private void onSlotHotkey(int index)
	{
		...
		if (spell != null && config.spell() != spell)
		{
			...
			// ProjectXConfigPanel doesn't refresh individual widgets on ConfigChanged — force a rebuild
	...
	private void onEnabledToggleHotkey()
	{
		...
		// ProjectXConfigPanel doesn't subscribe to ConfigChanged for individual checkbox refresh, but it does
