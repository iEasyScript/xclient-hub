package net.runelite.client.plugins.projectx.mke_wintertodt.startup.inventory;
...
public class WintertodtInventoryManager {
    ...
    public boolean setupInventory() {
        try {
            ProjectX.log("Setting up Wintertodt inventory...");
            ...
            if (!Rs2Bank.isOpen()) {
                ...
                if (!Rs2Bank.openBank()) {
                    ProjectX.log("Failed to open bank for inventory setup");
                    return false;
                }
            }
            ...
            ProjectX.log("Error setting up inventory: " + e.getMessage());
            return false;
        }
    }
    ...
    private void moveItemToSlot(int itemId, int targetSlot, String description) {
        try {
            ...
            ProjectX.log("Error moving item " + itemId + " to slot " + targetSlot + ": " + e.getMessage());
        }
    }
    ...
    private void logInventorySetup() {
        ...
        if (tinderboxItem != null && tinderboxItem.getSlot() == TINDERBOX_SLOT) {
            ProjectX.log("  Slot 25: Tinderbox ✓");
        }
        ...
        for (int axeId : AXE_PRIORITY) {
            ...
            if (axeItem != null && axeItem.getSlot() == AXE_SLOT) {
                ProjectX.log("  Slot 24: " + getAxeName(axeId) + " ✓");
                break;
            }
        }
        
        ProjectX.log("Left side free for logs, kindling and food");
    }
    ...
    public void reset() {
        ...
        ProjectX.log("Inventory manager state reset - ready for fresh setup");
    }
