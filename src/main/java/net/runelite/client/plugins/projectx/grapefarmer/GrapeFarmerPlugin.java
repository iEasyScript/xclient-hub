...
import net.runelite.client.plugins.projectx.grapefarmer.GrapeFarmerOverlay;
import net.runelite.client.plugins.projectx.grapefarmer.GrapeFarmerScript;
...
public class GrapeFarmerPlugin extends Plugin {
    ...
    @Inject
    private net.runelite.client.plugins.projectx.grapefarmer.GrapeFarmerConfig config;
    @Provides
    net.runelite.client.plugins.projectx.grapefarmer.GrapeFarmerConfig provideConfig(ConfigManager configManager) {
