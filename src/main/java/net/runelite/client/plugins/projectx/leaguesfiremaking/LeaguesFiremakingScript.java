package net.runelite.client.plugins.projectx.leaguesfiremaking;
...
public class LeaguesFiremakingScript extends Script {
    ...
    private void handleBanking(LeaguesFiremakingConfig config) {
        ...
        if (!Rs2Bank.hasItem(TINDERBOX_ID)) {
            ...
            ProjectX.log("No tinderbox found in bank.");
            shutdown();
            return;
        }
        ...
        if (!Rs2Bank.hasItem(activeLogType.getItemId())) {
            ...
            ProjectX.log("No " + activeLogType.getLogName() + " found in bank.");
            shutdown();
            return;
        }
