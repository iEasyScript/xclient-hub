package net.runelite.client.plugins.projectx.sailing.features.trials;
...
import net.runelite.client.plugins.projectx.sailing.features.trials.data.*;
import net.runelite.client.plugins.projectx.sailing.features.trials.debug.BoatPathHelper;
...
public class TrialsScript {
    ...
    public void run(SailingConfig config) {
        try {
            ...
            ProjectX.getClientThread().invoke(() -> client.setHintArrow(hintTarget));
    ...
    private void navigateToWaypoint(WorldPoint target) {
        var boat = ProjectX.getClientThread().invoke(() -> boatCache.getLocalBoat());
        if (boat == null) {
    ...
    private void resetState() {
        ...
        activeRoute = null;
        lastVisitedIndex = -1;
        ProjectX.getClientThread().invoke(() -> client.clearHintArrow());
    }
