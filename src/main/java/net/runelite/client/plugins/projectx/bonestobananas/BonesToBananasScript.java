package net.runelite.client.plugins.projectx.bonestobananas;

import net.runelite.api.gameval.ItemID;
import net.runelite.client.plugins.projectx.ProjectX;
import net.runelite.client.plugins.projectx.Script;
import net.runelite.client.plugins.projectx.bonestobananas.util.ElementalStaff;
...
public class BonesToBananasScript extends Script {
        ...
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            try {
                ...
                if (!BONES_TO_BANANAS_SPELL.hasRequiredLevel()) {
                    ProjectX.showMessage("Magic level is too low.");
                    shutdown();
                    return;
                }
    ...
    private void handleBoneWithdrawal() {
        if (!Rs2Bank.hasItem(BONES_ID)) {
            ProjectX.showMessage("You have no bones left in your bank.");
            shutdown();
            return;
        }
