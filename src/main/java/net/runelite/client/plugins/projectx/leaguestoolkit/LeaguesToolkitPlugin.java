...
@PluginDescriptor(
        ...
        tags = {"leagues", "projectx", "utility", "afk"},
    ...
    public void onProjectileMoved(ProjectileMoved event) {
        ...
        if (id == 3680) {
            ...
            if (!helper.isVineDetected()) {
                ...
                var player = net.runelite.client.plugins.projectx.ProjectX.getClient().getLocalPlayer();
                if (player != null) {
                    ...
                    var poly = net.runelite.api.Perspective.getCanvasTilePoly(
                            net.runelite.client.plugins.projectx.ProjectX.getClient(), dodgeLocal);
                    if (poly != null) {
