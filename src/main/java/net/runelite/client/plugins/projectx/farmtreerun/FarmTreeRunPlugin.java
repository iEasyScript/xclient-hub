...
@PluginDescriptor(
        ...
        cardUrl = "https://ieasyscript.github.io/xclient-hub/FarmTreeRunPlugin/assets/card.jpg",
        iconUrl = "https://ieasyscript.github.io/xclient-hub/FarmTreeRunPlugin/assets/icon.jpg",
...
public class FarmTreeRunPlugin extends Plugin {
    ...
    @Inject
    net.runelite.client.plugins.projectx.farmtreerun.FarmTreeRunScript FarmTreeRunScript;
