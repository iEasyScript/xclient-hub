package net.runelite.client.plugins.projectx.varrockanvil;
...
import net.runelite.client.plugins.projectx.varrockanvil.enums.AnvilItem;
import net.runelite.client.plugins.projectx.varrockanvil.enums.Bars;
        ...
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            ...
            switch (state) {
                case SMITHING:
                    ...
                    if (ProjectX.getRs2TileObjectCache().query().withId(2097).interact()) {
                        debug("Using anvil");
                        ...
                        if (Rs2Widget.getWidget(AnvilContainerWidgetID, 1) != null) {
                            if (ProjectX.getVarbitPlayerValue(AnvilMakeVarbitPlayer) < Rs2Inventory.count(barType.getId())) {
