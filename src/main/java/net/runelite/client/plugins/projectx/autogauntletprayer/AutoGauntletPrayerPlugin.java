package net.runelite.client.plugins.projectx.autogauntletprayer;
...
public class AutoGauntletPrayerPlugin extends Plugin {
    ...
    public void onGameTick(GameTick event) {
        ...
        Rs2NpcModel hunllef = ProjectX.getRs2NpcCache().query().where(npc -> HUNLLEF_IDS.contains(npc.getId())).toList().stream()
                .findFirst()
                .orElse(null);
