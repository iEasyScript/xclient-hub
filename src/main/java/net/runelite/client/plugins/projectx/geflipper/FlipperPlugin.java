...
public class FlipperPlugin extends Plugin {
    ...
    @Inject
    private net.runelite.client.plugins.projectx.geflipper.FlipperConfig config;

    @Provides
    net.runelite.client.plugins.projectx.geflipper.FlipperConfig provideConfig(ConfigManager configManager) {
