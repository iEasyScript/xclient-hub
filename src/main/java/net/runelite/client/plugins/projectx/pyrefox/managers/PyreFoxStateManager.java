...
import static net.runelite.client.plugins.projectx.pyrefox.enums.PyreFoxState.*;
...
public class PyreFoxStateManager extends Script
{
	...
	{
//		ProjectX.log(Rs2Player.distanceTo(PyreFoxConstants.PYRE_FOX_CENTER_POINT) + "");
		...
		var trap = trapPoint != null ? ProjectX.getRs2TileObjectCache().query().within(PyreFoxConstants.TRAP_OBJECT_POINT, 0).first() : null;
