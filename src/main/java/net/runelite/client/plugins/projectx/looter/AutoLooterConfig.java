...
import net.runelite.client.plugins.projectx.looter.enums.FlaxLocations;
import net.runelite.client.plugins.projectx.looter.enums.LooterActivity;
import net.runelite.client.plugins.projectx.looter.enums.NatureRuneChestLocations;
