...
import net.runelite.client.plugins.projectx.farmtreerun.enums.CompostType;
import net.runelite.client.plugins.projectx.farmtreerun.enums.HardTreeEnums;
import net.runelite.client.plugins.projectx.farmtreerun.enums.FruitTreeEnum;
import net.runelite.client.plugins.projectx.farmtreerun.enums.TreeEnums;
...
public class FarmTreeRunScript extends Script {
    public static net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState botStatus;
    ...
    public enum Patch {
        ...
        public boolean hasRequiredLevel() {
            if (Rs2Player.getSkillRequirement(Skill.FARMING, this.farmingLevel))
                return true;
            ProjectX.showMessage(this.name() + " requires level " + this.farmingLevel + " farming.");
            return false;
        }
    }
    ...
    public boolean run(FarmTreeRunConfig config) {
        ...
        botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.BANKING;
        ...
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            try {
                ...
                if(!Rs2Magic.isSpellbook(Rs2Spellbook.MODERN)){
                    ProjectX.log("Not on modern spell book");
                    shutdown();
                }
				...
				switch (botStatus) {
					case BANKING:
						if (config.banking()) {
							...
							botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_GNOME_STRONGHOLD_FRUIT_PATCH;
						}
						break;
					case HANDLE_GNOME_STRONGHOLD_FRUIT_PATCH:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_GNOME_STRONGHOLD_TREE_PATCH;
						break;
					case HANDLE_GNOME_STRONGHOLD_TREE_PATCH:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_TREE_GNOME_VILLAGE_FRUIT_TREE_PATCH;
						break;
					case HANDLE_FARMING_GUILD_TREE_PATCH:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_FARMING_GUILD_FRUIT_PATCH;
						break;
					case HANDLE_FARMING_GUILD_FRUIT_PATCH:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_TAVERLEY_TREE_PATCH;
						break;
					case HANDLE_BRIMHAVEN_FRUIT_TREE_PATCH:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_CATHERBY_FRUIT_TREE_PATCH;
						break;
					case HANDLE_TREE_GNOME_VILLAGE_FRUIT_TREE_PATCH:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_FARMING_GUILD_TREE_PATCH;
						break;
					case HANDLE_TAVERLEY_TREE_PATCH:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_FALADOR_TREE_PATCH;
						break;
					case HANDLE_FALADOR_TREE_PATCH:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_LUMBRIDGE_TREE_PATCH;
						break;
					case HANDLE_LUMBRIDGE_TREE_PATCH:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_VARROCK_TREE_PATCH;
						break;
					case HANDLE_VARROCK_TREE_PATCH:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_BRIMHAVEN_FRUIT_TREE_PATCH;
						break;
					case HANDLE_CATHERBY_FRUIT_TREE_PATCH:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_FOSSIL_TREE_PATCH_A;
						break;
					case HANDLE_FOSSIL_TREE_PATCH_A:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_FOSSIL_TREE_PATCH_B;
						break;
					case HANDLE_FOSSIL_TREE_PATCH_B:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_FOSSIL_TREE_PATCH_C;
						break;
					case HANDLE_FOSSIL_TREE_PATCH_C:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_LLETYA_FRUIT_TREE_PATCH;
						break;
					case HANDLE_LLETYA_FRUIT_TREE_PATCH:
						...
						botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_AUBURNVALE_TREE_PATCH;
						break;
                    ...
                    case HANDLE_AUBURNVALE_TREE_PATCH: {
                        ...
                        botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_KASTORI_FRUIT_TREE_PATCH;
                        break;
                    }
                    case HANDLE_KASTORI_FRUIT_TREE_PATCH: {
                        ...
                        botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_PRIFFDDINAS_CRYSTAL_TREE_PATCH;
                        break;
                    }
                    case HANDLE_PRIFFDDINAS_CRYSTAL_TREE_PATCH: {
                        ...
                        botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.HANDLE_AVIUM_SAVANNAH_HARDWOOD_PATCH;
                        break;
                    }
                    ...
                    case HANDLE_AVIUM_SAVANNAH_HARDWOOD_PATCH: {
                        ...
                        botStatus = net.runelite.client.plugins.projectx.farmtreerun.enums.FarmTreeRunState.FINISHED;
                        break;
                    }
                    ...
                    case FINISHED:
						...
						ProjectX.getClientThread().runOnClientThreadOptional(() -> {
								ProjectX.getClient().addChatMessage(ChatMessageType.ENGINE, "", "Tree run completed.", "Acun", false);
								ProjectX.getClient().addChatMessage(ChatMessageType.ENGINE, "", "Made with love by Acun.", "Acun", false);
								return null;
							}
						);
						shutdown();
    ...
    private void calculatePatches(FarmTreeRunConfig config) {
        if (getSelectedTreePatches(config).isEmpty() && getSelectedFruitTreePatches(config).isEmpty() && getSelectedHardTreePatches(config).isEmpty()) {
            ProjectX.showMessage("You must select at least one patch. Shut down.");
            shutdown();
    ...
    private boolean validateSpecialPatches(FarmTreeRunConfig config) {
        if (config.enableTrees() && config.priffddinasCrystalTreePatch()) {
            ...
            if (farmingLevel < 74) {
                ProjectX.showMessage("Prifddinas Crystal tree requires 74 Farming (you have " + farmingLevel + "). Disable the Prifddinas patch or train Farming before starting. Shutting down.");
                shutdown();
                return false;
            }
            if (Rs2Player.getQuestState(Quest.SONG_OF_THE_ELVES) != QuestState.FINISHED) {
                ProjectX.showMessage("Prifddinas Crystal tree requires Song of the Elves to be completed. Disable the Prifddinas patch before starting. Shutting down.");
                shutdown();
                return false;
            }
        }
        ...
        if (Rs2Bank.openBank() || Rs2Bank.walkToBank()) {
            ...
            if (isCompostEnabled(config)) {
                ...
                if (compostType.isReusable()) {
                    if (Rs2Bank.hasItem(compostItemId)) {
                        ...
                        ProjectX.log("Bottomless compost bucket not found in bank. Skipping composting.");
                        compostItemId = null;
                    }
                }
            }
            ...
            if (config.useSkillsNecklace() && ((config.enableTrees() && config.farmingGuildTreePatch()) || (config.enableFruitTrees() && config.farmingGuildFruitTreePatch()))) {
                if (Rs2Bank.hasItem(ItemID.SKILLS_NECKLACE6)) {
                    ...
                    ProjectX.log("No skills necklace found in bank. Skipping.");
                }
            }
            ...
            if (config.enableFruitTrees() && config.lletyaFruitTreePatch()) {
                if (Rs2Bank.hasItem(ItemID.ETERNAL_TELEPORT_CRYSTAL)) {
                    ...
                    ProjectX.showMessage("Would not be able to teleport to Lleyta");
                    shutdown();
                }
            }
...
//              TODO: Need to handle what happens if a required item does not exist
...

            {
                ...
                if (!toggled || !Rs2Bank.hasWithdrawAsItem()) {
                    ProjectX.log("Failed to toggle bank to item mode");
                    shutdown();
                    return;
                }
            }
            ...
            if (!notedItems.isEmpty()) {
                ...
                if (!toggled || !Rs2Bank.hasWithdrawAsNote()) {
                    ProjectX.log("Failed to toggle bank to noted mode");
                    shutdown();
                    return;
                }
                sleep(300, 900);
    ...
    private void checkIfPlayerHasItem(FarmingItem item) {
        if (!Rs2Bank.hasItem(new int[]{item.getItemId()}, item.getQuantity()) && !item.isOptional()) {
            ProjectX.showMessage("Not enough items: " + ProjectX.getClientThread().runOnClientThreadOptional(() -> ProjectX.getClient().getItemDefinition(item.getItemId()).getName()) + ". " +
    ...
    private void checkIfPlayerHasItem(int itemId, int quantity, boolean optional) {
        if (!Rs2Bank.hasItem(new int[]{itemId}, quantity) && !optional) {
            ProjectX.showMessage("Not enough items: " + ProjectX.getClientThread().runOnClientThreadOptional(() -> ProjectX.getClient().getItemDefinition(itemId).getName()) + ". Need " + quantity + ". Shut down.");
            shutdown();
        }
    }
    ...
    private boolean handlePlantingTree(GameObject treePatch, Patch patch, FarmTreeRunConfig config) {
        ...
        if (useCompostOnPatch(config, patch)) {
            ...
            if (!hasCompost && !config.compostType().isReusable()) {
                ...
                if (!hasCompost) {
                    ProjectX.showMessage("Tool Leprechaun has no " + config.compostType() + ". Store compost with the leprechaun before starting.");
                    shutdown();
                    return false;
                }
            }
    ...
    private Integer getLinkedId(int id) {
        return ProjectX.getClientThread().runOnClientThreadOptional(() -> {
            ItemComposition comp = ProjectX.getItemManager().getItemComposition(id);
    ...
    private void handleExoticGardeners() {
        var nikkie = ProjectX.getRs2NpcCache().query().withName("Nikkie").nearestOnClientThread();

        var rosie = ProjectX.getRs2NpcCache().query().withName("Rosie").nearestOnClientThread();

        String paymentAction = "";
        net.runelite.client.plugins.projectx.api.npc.models.Rs2NpcModel npcToInteract = null;

        if (rosie == null && nikkie == null) {
            ProjectX.log("Gardeners in farming guild not found. Report this bug.");
            shutdown();
...
//
//
//        TimeTrackingPlugin timeTrackingPlugin = (TimeTrackingPlugin) ProjectX.getPlugin(TimeTrackingPlugin.class.getName());
//
...
//                ProjectX.log(String.valueOf(prediction.getProduce()));
//                ProjectX.log(String.valueOf(prediction.getCropState()));
//                ProjectX.log(prediction.getStage() + "/" + prediction.getStages());
//            }
//        }
//
//        return true;
