package net.runelite.client.plugins.projectx.leaguestoolkit;
...
public class HesporiBossHelper {
    ...
    public void tick() {
        ...
        int anim = ProjectX.getClientThread().runOnClientThreadOptional(
    ...
    private void handleFlowerPhase() {
        ...
        HeadIcon flowerPrayer = ProjectX.getClientThread().runOnClientThreadOptional(
                () -> flower.getHeadIcon()
        ).orElse(null);
    ...
    public boolean handleVineDodge() {
        ...
        LocalPoint myLocal = ProjectX.getClientThread().runOnClientThreadOptional(() -> {
    ...
    private Rs2NpcModel findActiveFlower() {
        ...
        return ProjectX.getRs2NpcCache().query()
                ...
                .where(npc -> {
                    ...
                    HeadIcon icon = ProjectX.getClientThread().runOnClientThreadOptional(
                            () -> npc.getHeadIcon()
                    ).orElse(null);
    ...
    public void tickCombat() {
        ...
        boolean alreadyFighting = ProjectX.getClientThread().runOnClientThreadOptional(() -> {
            var player = ProjectX.getClient().getLocalPlayer();
        ...
        if (!alreadyFighting) {
            ...
            ProjectX.getClientThread().invoke(() -> {
                try {
                    ...
                    var comp = ProjectX.getClient().getNpcDefinition(rawNpc.getId());
                    if (comp != null) {
