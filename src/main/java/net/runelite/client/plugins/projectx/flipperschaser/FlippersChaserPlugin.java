package net.runelite.client.plugins.projectx.flipperschaser;
...
@PluginDescriptor(
        ...
        tags = {"service", "automation", "combat", "projectx"},
        authors = {"Bttqjs"},
...
public class FlippersChaserPlugin extends Plugin {
    ...
    public void onNpcSpawned(NpcSpawned event) {
        ...
        if (npc.getName().equals("Mogre")) {
            inCombat = true;
            var rs2Npc = ProjectX.getRs2NpcCache().query().where(n -> n.getNpc().equals(npc)).nearest();
    ...
    private Rs2NpcModel findFishingSpot() {
        return ProjectX.getRs2NpcCache().query().withName("Ominous Fishing Spot").nearestOnClientThread();
    }
