...
import net.runelite.client.plugins.projectx.qualityoflife.enums.CraftingItem;
import net.runelite.client.plugins.projectx.qualityoflife.enums.FletchingItem;
