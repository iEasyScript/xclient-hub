...
import net.runelite.client.plugins.projectx.shootingstar.model.ShootingStarTableHeader;
import net.runelite.client.plugins.projectx.shootingstar.model.ShootingStarTableRow;
...
public class ShootingStarPanel extends PluginPanel
{
	...
	private JPopupMenu buildPopupMenu(ShootingStarTableRow row, Star star)
	{
		...
		hopEntryOption.addActionListener(e -> ProjectX.hopToWorld(star.getWorld()));
