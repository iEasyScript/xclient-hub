package net.runelite.client.plugins.projectx.cooking;
...
import net.runelite.client.plugins.projectx.cooking.scripts.AutoCookingScript;
import net.runelite.client.plugins.projectx.cooking.scripts.BurnBakingScript;
...
@PluginDescriptor(
        ...
        description = "ProjectX cooking plugin",
        tags = {"cooking", "projectx", "skilling"},
        authors = {"George"},
        version = AutoCookingPlugin.version,
        minClientVersion = "2.0.8",
        cardUrl = "https://ieasyscript.github.io/xclient-hub/AutoCookingPlugin/assets/card.jpg",
        iconUrl = "https://ieasyscript.github.io/xclient-hub/AutoCookingPlugin/assets/icon.jpg",
    ...
    protected void startUp() throws AWTException {
        ...
        switch (config.cookingActivity()) {
            ...
            case BURN_BAKING:
                ...
                break;
            default:
                ProjectX.log("Invalid Cooking Activity");
        }
    }
