...
public class AutoBuyerPlugin extends Plugin {
    ...
    @Inject
    private net.runelite.client.plugins.projectx.autobuyer.AutoBuyerConfig config;

    @Provides
    net.runelite.client.plugins.projectx.autobuyer.AutoBuyerConfig provideConfig(ConfigManager configManager) {
