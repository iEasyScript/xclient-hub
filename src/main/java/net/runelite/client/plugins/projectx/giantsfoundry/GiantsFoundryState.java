...
import net.runelite.client.plugins.projectx.giantsfoundry.enums.Heat;
...
import static net.runelite.client.plugins.projectx.giantsfoundry.enums.Stage.*;
...
public class GiantsFoundryState {
    ...
    public static int getHeatAmount() {
        return ProjectX.getVarbitValue(VARBIT_HEAT);
    }

    public static int getProgressAmount() {
        return ProjectX.getVarbitValue(VARBIT_PROGRESS);
    }
    ...
    public static Rs2TileObjectModel getStageObject(Stage stage) {
        switch (stage) {
            case TRIP_HAMMER:
                return ProjectX.getRs2TileObjectCache().query().withName("trip hammer").nearestOnClientThread();
            case GRINDSTONE:
                return ProjectX.getRs2TileObjectCache().query().withName("grindstone").nearestOnClientThread();
            case POLISHING_WHEEL:
                return ProjectX.getRs2TileObjectCache().query().withName("polishing wheel").nearestOnClientThread();
        }
        return null;
    }
    ...
    {
        return ProjectX.getClient().getVarpValue(173) == 1;
    }
