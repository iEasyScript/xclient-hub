...
@PluginDescriptor(
        ...
        tags = {"astral", "rune", "projectx"},
        authors = { "Maxxin" },
        version = AstralRunesPlugin.version,
        minClientVersion = "2.0.7",
        iconUrl = "https://ieasyscript.github.io/xclient-hub/AstralRunesPlugin/assets/icon.png",
        cardUrl = "https://ieasyscript.github.io/xclient-hub/AstralRunesPlugin/assets/card.png",
...
public class AstralRunesPlugin extends Plugin {
    ...
    public void onChatMessage(ChatMessage event) {
        if (event.getType() == ChatMessageType.GAMEMESSAGE && !ProjectX.pauseAllScripts.get()) {
            if (event.getMessage().toLowerCase().contains("you don't have enough coins.")) {
                ProjectX.status = "[Shutting down] - Reason: Not enough coins.";
