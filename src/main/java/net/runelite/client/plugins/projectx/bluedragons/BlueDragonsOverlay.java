...
public class BlueDragonsOverlay extends OverlayPanel {
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        WorldPoint playerLocation = ProjectX.getClient().getLocalPlayer().getWorldLocation();
        ...
        Rs2NpcModel nearestDragon = ProjectX.getRs2NpcCache().query().withName("Blue dragon").nearestOnClientThread();
    ...
    private void drawSafeSpot(Graphics2D graphics) {
        LocalPoint localSafeSpot = LocalPoint.fromWorld(ProjectX.getClient().getTopLevelWorldView(), BlueDragonsScript.SAFE_SPOT);
