...
public class AnagramClueTask extends ClueTask {
    ...
    private void transitionToInteractionState() {
        ...
        } else if (clue.getNpcProvider() != null && ProjectX.getRs2NpcCache().query().withName(clue.getNpcName(clueScrollPlugin)).nearestOnClientThread() != null) {
    ...
    private boolean interactWithObject() {
        ...
        boolean interacted = ProjectX.getRs2TileObjectCache().query().interact(targetObject, "Search")
    ...
    private boolean interactWithNpc() {
        var targetNpc = ProjectX.getRs2NpcCache().query().withName(clue.getNpcName(clueScrollPlugin)).nearestOnClientThread();
        if (targetNpc == null) {
