package net.runelite.client.plugins.projectx.piebaker;
...
public class PieBakerPlugin extends Plugin {
    ...
    protected void startUp() {
        ...
        startCookingXP = ProjectX.getClient().getSkillExperience(Skill.COOKING);
    }
    ...
    public int getMagicXPPerHour() {
        int currentXP = ProjectX.getClient().getSkillExperience(Skill.MAGIC);
