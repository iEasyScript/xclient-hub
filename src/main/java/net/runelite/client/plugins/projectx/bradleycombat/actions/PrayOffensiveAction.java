...
import net.runelite.client.plugins.projectx.bradleycombat.enums.PrayerStyle;
...
import static net.runelite.client.plugins.projectx.util.prayer.Rs2Prayer.isPrayerActive;
import static net.runelite.client.plugins.projectx.util.prayer.Rs2Prayer.toggle;
