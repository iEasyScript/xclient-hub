package net.runelite.client.plugins.projectx.moonlightmoth;
...
public class MoonlightMothScript extends Script {
    ...
    public boolean run(MoonlightMothConfig config) {
        ...
        ProjectX.getClientThread().runOnClientThreadOptional(() -> {
            var itemManager = ProjectX.getItemManager();
    ...
    private void checkState(MoonlightMothConfig config) {
        ProjectX.status = "Checking current state...";
    ...
    private void handleBanking(MoonlightMothConfig config) {
        ProjectX.status = "Banking process initiated";
    ...
    private void handleShopping(MoonlightMothConfig config) {
        ProjectX.status = "Shopping process initiated";
    ...
    private void handleCatching(MoonlightMothConfig config) {
        ProjectX.status = "Catching Moonlight Moths...";
        ...
        ProjectX.getRs2NpcCache().query().withId(NpcID.MOTH_MOONLIGHT).where(moth -> {
