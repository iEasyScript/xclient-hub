...
import net.runelite.client.plugins.projectx.playermonitor.enums.SoundEffectID;
import net.runelite.client.plugins.projectx.playermonitor.enums.emergencyOptions;
