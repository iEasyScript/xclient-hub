package net.runelite.client.plugins.projectx.gebotrecruiter;
...
public class RecruiterScript extends Script {
                ...
                if (config.recruit()) {
                    ...
                    for (Rs2PlayerModel player : localPlayers) {
                        ...
                        if (menuAction != null) {
                            ...
                            // Set this menu entry as the target menu in ProjectX
                            ProjectX.targetMenu = recruitMenuEntry;

                            // Invoke the "Recruit" action programmatically
                            ProjectX.doInvoke(recruitMenuEntry, player.getCanvasTilePoly().getBounds());
    ...
    private void moveMouseToPlayer(Player player) {
        ...
        if (playerBounds != null) {
            ...
            if (randomPoint != null) {
                ...
                ProjectX.getMouse().move(randomPoint.getX(), randomPoint.getY());
    ...
    private MenuAction findRecruitAction() {
        MenuEntry[] menuEntries = ProjectX.getClient().getMenuEntries();
