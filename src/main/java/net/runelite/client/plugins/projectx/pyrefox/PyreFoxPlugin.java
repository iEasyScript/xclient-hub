package net.runelite.client.plugins.projectx.pyrefox;
...
import net.runelite.client.plugins.projectx.pyrefox.PyreFoxOverlay;
import net.runelite.client.plugins.projectx.pyrefox.enums.PyreFoxState;
import net.runelite.client.plugins.projectx.pyrefox.managers.PyreFoxScript;
import net.runelite.client.plugins.projectx.pyrefox.managers.PyreFoxStateManager;
...
public class PyreFoxPlugin extends Plugin {
    ...
    @Inject
    private net.runelite.client.plugins.projectx.pyrefox.PyreFoxConfig config;
    private Instant scriptStartTime;

    @Provides
    net.runelite.client.plugins.projectx.pyrefox.PyreFoxConfig provideConfig(ConfigManager configManager) {
