...
@PluginDescriptor(
        ...
        tags = {"tithe farming", "projectx", "skills", "minigame"},
        authors = { "Mocrosoft" },
...
public class TitheFarmingPlugin extends Plugin {
    ...
    private final net.runelite.client.plugins.projectx.tithefarming.TitheFarmingScript titheFarmScript = new net.runelite.client.plugins.projectx.tithefarming.TitheFarmingScript();
    ...
    public void onItemContainerChanged(ItemContainerChanged event) {
        if (TitheFarmMaterial.getSeedForLevel() != null) {
            ...
            if (fruit != null) {
                net.runelite.client.plugins.projectx.tithefarming.TitheFarmingScript.fruits = fruit.getQuantity() - net.runelite.client.plugins.projectx.tithefarming.TitheFarmingScript.initialFruit;
            }
        }
    }
    ...
    public void onChatMessage(ChatMessage chatMessage)
    {
        ...
        if (message.contains("%")) {
            ...
            if (matcher.find()) {
                ...
                net.runelite.client.plugins.projectx.tithefarming.TitheFarmingScript.gricollerCanCharges = (int) (Float.parseFloat(percentage));
            }
        } else if (message.equalsIgnoreCase("Gricoller's can is already full.")) {
            net.runelite.client.plugins.projectx.tithefarming.TitheFarmingScript.gricollerCanCharges = 100;
