...
/**
 * Self-contained test that launches the ProjectX client with the Agent Server
 * plugin, logs in, then exercises the /scripts HTTP endpoints.
 *
 * Usage:
 *   ./gradlew test --tests ScriptLifecycleTest \
 *       -PprojectxClientPath=/path/to/projectx-2.2.0.jar
 *
 * Or run main() from your IDE with projectx 2.2.0 on the classpath.
 */
public class ScriptLifecycleTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String pluginClass = "net.runelite.client.plugins.projectx.breakhandler.BreakHandlerPlugin";
