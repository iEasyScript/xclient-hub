...
* **Anti-Ban Support**: The plugin uses ProjectX's anti-ban system to mimic human-like behavior, with features like natural mouse movements and non-linear action intervals.
