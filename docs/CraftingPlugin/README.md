...
The **Crafting Plugin** is a comprehensive automation tool for Old School RuneScape, designed to streamline and optimize Crafting training by supporting a wide variety of crafting activities. Built for the ProjectX RuneLite client, this plugin automates crafting processes, inventory management, and banking, allowing for efficient and hands-free Crafting experience gains.
...
1. **Enable the Plugin:**  
   Open the ProjectX sidebar, find the Crafting Plugin, and enable it.
