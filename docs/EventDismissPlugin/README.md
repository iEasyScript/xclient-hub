...
The **Event Dismiss Plugin** is a utility tool for Old School RuneScape, designed to automatically dismiss random event NPCs that appear during gameplay. Built for the ProjectX RuneLite client, this plugin helps keep your gameplay uninterrupted by quickly and efficiently handling unwanted random events.
...
1. **Enable the Plugin:**  
   Open the ProjectX sidebar, find the Event Dismiss Plugin, and enable it.
