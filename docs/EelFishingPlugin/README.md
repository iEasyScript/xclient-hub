...
The **Eel Fishing Plugin** is an automation tool for Old School RuneScape, designed to efficiently train Fishing by automating the process of catching various types of eels (such as sacred, lava, or slimy eels) at supported fishing spots. Built for the ProjectX RuneLite client, this plugin streamlines fishing, inventory management, and banking, allowing for hands-free and optimized Fishing experience gains.
...
1. **Enable the Plugin:**  
   Open the ProjectX sidebar, find the Eel Fishing Plugin, and enable it.
