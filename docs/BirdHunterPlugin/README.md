...
The **Bird Hunter Plugin** is a RuneLite plugin for the ProjectX framework that automates bird house runs and bird hunting activities in Old School RuneScape (OSRS). It is designed to help players efficiently set up, check, and collect bird houses, making hunter training more convenient and less time-consuming.
