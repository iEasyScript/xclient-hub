...
The **Farm Tree Run Plugin** is an automation tool for Old School RuneScape, designed to efficiently manage and complete tree and fruit tree farming runs. Built for the ProjectX RuneLite client, this plugin streamlines the process of planting, checking, and harvesting trees across all major farming patches, allowing for hands-free and optimized Farming experience gains.
...
1. **Enable the Plugin:**  
   Open the ProjectX sidebar, find the Farm Tree Run Plugin, and enable it.
