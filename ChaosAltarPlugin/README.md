...
The **Chaos Altar Plugin** is an automation tool for Old School RuneScape, designed to maximize Prayer experience by automating the process of offering bones at the Chaos Altar in the Wilderness. Built for the ProjectX RuneLite client, this plugin streamlines bone offering, inventory management, and banking, allowing for efficient and hands-free Prayer training.
...
1. **Enable the Plugin:**  
   Open the ProjectX sidebar, find the Chaos Altar Plugin, and enable it.
