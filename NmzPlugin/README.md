# NMZ Plugin  Overview
## Purpose
NmzScript automates the Nightmare Zone (NMZ) minigame in Old School RuneScape using the ProjectX framework. It manages inventory, potion usage, combat, prayer, and in-game interactions to maximize efficiency and survivability during NMZ runs.
