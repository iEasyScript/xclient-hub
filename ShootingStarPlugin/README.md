...
![preview](https://azpublicfiles.blob.core.windows.net/projectx/shooting-star-preview.gif)
...
- **Antiban Support**: Uses ProjectX's antiban system for safer, more human-like behavior.
...
## Setup
1. Make sure you have ProjectX and this plugin installed.
...
- **Other issues:** Try restarting your client, check for plugin updates, or create an issue on the projectx-hub repository.
