...
The **Minnows Fishing Plugin** is an automation tool for Old School RuneScape, designed to efficiently catch minnows at the Fishing Guild. Built for the ProjectX RuneLite client, this plugin streamlines the process of fishing for minnows, managing inventory, and handling moving fishing spots, allowing for hands-free and optimized Fishing experience and profit.
...
1. **Enable the Plugin:**  
   Open the ProjectX sidebar, find the Minnows Fishing Plugin, and enable it.
