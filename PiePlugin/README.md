...
The **Nate Pie Shells Plugin** is an automation tool for Old School RuneScape, designed to streamline and optimize the process of making pie shells. This plugin is built for the ProjectX RuneLite client and provides a hands-free, efficient way to train Cooking and prepare pie shells for further baking or trading.
...
1. **Enable the Plugin:**  
   Open the ProjectX sidebar, find the Nate Pie Shells Plugin, and enable it.
